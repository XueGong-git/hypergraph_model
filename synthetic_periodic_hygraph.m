...
for input = 2
    for gamma = 5
        ...
        case 1 
            ...
            data_type = "uniform";
        case 2 
            x = sort(repmat(linspace(2*pi/K,2*pi,K),1,m)+(2*a*rand(1,n)-a)); % trophic levels
            data_type = "cluster";
        case 3
        ...
        [W2, W3] = GeneratePeriodicHypergraph(x, gamma, c2, c3, data_type);
        ...
        [x_est] = PeriodicHypergraphEmbedding(W2, W3, c2, c3, "true");
