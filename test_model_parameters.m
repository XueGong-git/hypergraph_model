...
gamma_input = 5; %0:1:10; % gamma for generating graph
c3_inp_array = 0:0.05:0.4; % weight of triangles for input graph
c3_inv_array = 0:0.05:0.4; % weight of triangles for inverse problem
        ...
        for kk = 1:length(gamma_input)
            ...
            for jj = 1:length(c3_inv_array)
                ...
                for ll = 1 %:length(gamma_array)
                    test_gamma = gamma;%gamma_array(ll);
