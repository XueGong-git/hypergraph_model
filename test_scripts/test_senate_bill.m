...
[x_est, V, lambda] = LinearHypergraphEmbedding(W2, W3, c2, c3);
...
set(gca,'fontsize',30);
ax = gca;
exportgraphics(ax,strcat('plots/',data_type,'_eigenvalues_c3=',num2str(round(c3,1)),'.eps'),'Resolution',300) 
